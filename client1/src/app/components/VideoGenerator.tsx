...
export default function VideoGenerator() {
  ...
  return (
    <div className="bg-[#2F3438] rounded-lg shadow-lg p-3 sm:p-4 border border-[#787774]/20 overflow-visible">
      <div className="flex items-center justify-between mb-2 pb-2 border-b border-[#787774]/20">
        <div className="flex items-center gap-3">
          <button
            onClick={() => router.push('/projects')}
            className="p-1.5 hover:bg-[#787774]/20 rounded-md text-[#F1F1EF] transition-colors"
          ...
          <div className="flex items-center gap-2">
            <h1 className="text-base font-bold text-[#F1F1EF]">{topic || 'New Project'}</h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-2 hover:bg-[#787774]/20 rounded-md text-[#787774] hover:text-[#F1F1EF] transition-colors"
          ...
          {generatedVideo ? (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#337EA9] hover:bg-[#337EA9]/80 text-[#F1F1EF] rounded-md transition-colors font-medium text-sm"
            >
            ...
            <button
              disabled
              className="flex items-center gap-2 px-4 py-2 bg-[#2F3438] border border-[#787774]/30 text-[#787774] rounded-md text-sm cursor-not-allowed"
            >
              <Download className="w-4 h-4" />
              Export
            </button>
      ...
      {generatedVideo && (
        <div className="mt-6 p-4 bg-[#EDF3EC] border border-[#448361]/20 rounded-md">
          ...
          <div className="text-[#37352F] text-sm md:flex md:gap-6">
