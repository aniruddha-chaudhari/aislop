...
export const API_ENDPOINTS = {
  ...
  generateVideoImagePlan: `${API_BASE_URL}/api/video/generate-image-plan`,
  ...
  generatePreviewSegment: (projectId: string) => `${API_BASE_URL}/api/project/${projectId}/preview/segment`,
  getPreviewSegmentStatus: (projectId: string) => `${API_BASE_URL}/api/project/${projectId}/preview/segment/status`,
  generatePreviewHls: (projectId: string) => `${API_BASE_URL}/api/project/${projectId}/preview/hls`,
  getPreviewHlsStatus: (projectId: string) => `${API_BASE_URL}/api/project/${projectId}/preview/hls/status`,
