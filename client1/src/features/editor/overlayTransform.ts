...
/** Match backend1 preview/export: 960×720 base, 40px legacy top at 1080×1920. */
export const OVERLAY_BASE_W = 960;
export const OVERLAY_BASE_H = 720;
export const OVERLAY_LEGACY_TOP_Y = 40;
 ...
 * Mirrors backend1/src/service/overlayTransform.ts for WYSIWYG editor preview.
 */
export function computeOverlayPlacement(
  clip: Pick<OverlayClip, 'x' | 'y' | 'scale'>,
  frameWidth: number,
  frameHeight: number,
  baseWidth: number = OVERLAY_BASE_W,
  baseHeight: number = OVERLAY_BASE_H,
  legacyTopY: number = OVERLAY_LEGACY_TOP_Y
