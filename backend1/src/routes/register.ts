...
register([
  ...
  { method: 'POST', pattern: '/api/project/:id/hyperframes-animation-plan', handler: project.generateHyperframesAnimationPlanForProject },
  { method: 'POST', pattern: '/api/project/:id/hyperframes-animation-plan/approve', handler: project.approveHyperframesAnimationPlanForProject },
  { method: 'POST', pattern: '/api/project/:id/hyperframes-animation-plan/clip/:momentId/generate', handler: project.generateHyperframesAnimationClipForProject },
  { method: 'DELETE', pattern: '/api/project/:id/hyperframes-animation-plan', handler: project.deleteHyperframesAnimationPlanForProject },
